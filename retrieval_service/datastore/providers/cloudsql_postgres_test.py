    ...
    expected = [
        {
            ...
            "arrival_airport": "DEN",
            "departure_time": datetime.strptime(
                "2025-01-01 05:50:00", "%Y-%m-%d %H:%M:%S"
            ),
            "arrival_time": datetime.strptime(
                "2025-01-01 09:23:00", "%Y-%m-%d %H:%M:%S"
            ),
        }
    ]
...
validate_ticket_data = [
    pytest.param(
        ...
        models.Flight(
            ...
            arrival_time=datetime.strptime("2025-01-01 09:23:00", "%Y-%m-%d %H:%M:%S"),
            departure_gate="E49",
            arrival_gate="D6",
        ),
        'SELECT *<br/>FROM flights<br/>WHERE airline ILIKE UA<br/><div class="indent"></div>AND flight_number ILIKE 1532<br/><div class="indent"></div>AND departure_airport ILIKE SFO<br/><div class="indent"></div>AND departure_time = 2025-01-01 05:50:00',
    ),
    pytest.param(
        {
            "airline": "UA",
        ...
        'SELECT *<br/>FROM flights<br/>WHERE airline ILIKE UA<br/><div class="indent"></div>AND flight_number ILIKE 1158<br/><div class="indent"></div>AND departure_airport ILIKE SFO<br/><div class="indent"></div>AND departure_time = 2025-01-01 05:57:00',
    ),
    pytest.param(
        {
            "airline": "XX",
